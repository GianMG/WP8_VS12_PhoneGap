...
(function (window) {
    ...
    function Level(stage, contentManager, textLevel, gameWidth, gameHeight, scaleToFitX, scaleToFitY) {
        ...
        this.tileExitPosX = -1;
        this.tileExitPosY = -1;
        this.tileStartPosX = -1;
        this.tileStartPosY = -1;
        this.Exit = new Point(this.tileExitPosX, this.tileExitPosY);
        this.Score = 0;
    ...
    Level.prototype.UpdateRatio = function (gameWidth, gameHeight, scaleToFitX, scaleToFitY) {
        this.gameWidth = gameWidth;
        this.gameHeight = gameHeight;
        this.scaleToFitX = scaleToFitX;
        this.scaleToFitY = scaleToFitY;

        backgroundSeqTile1.scaleX = this.scaleToFitX;
        backgroundSeqTile1.scaleY = this.scaleToFitY;
        backgroundSeqTile2.scaleX = this.scaleToFitX;
        backgroundSeqTile2.scaleY = this.scaleToFitY;
        backgroundSeqTile3.scaleX = this.scaleToFitX;
        backgroundSeqTile3.scaleY = this.scaleToFitY;

        this.Hero.UpdateRatio(this.scaleToFitX, this.scaleToFitY);

        var ennemiesNumber = this.Enemies.length;

        for (var i = 0; i < ennemiesNumber; i++) {
            this.Enemies[i].UpdateRatio(scaleToFitX, scaleToFitY);
        }

        // Loop over every tile position,
        for (var i = 0; i < 15; i++) {
            for (var j = 0; j < 20; j++) {
                this.tiles[i][j].UpdateRatio(scaleToFitX, scaleToFitY);
            }
        }

        var gemsNumber = this.Gems.length;

        for (var i = 0; i < gemsNumber; i++) {
            this.Gems[i].UpdateRatio(scaleToFitX, scaleToFitY);
        }

        this.Exit = this.GetBounds(this.tileExitPosX, this.tileExitPosY).Center;
        this.Start = this.GetBounds(this.tileStartPosX, this.tileStartPosY).GetBottomCenter();
    };
    ...
    Level.prototype.LoadTile = function (tileType, x, y) {
        switch (tileType) {
            // Blank space                                                                                                                        
            case '.':
                return new Tile(null, Enum.TileCollision.Passable, x, y, this.scaleToFitX, this.scaleToFitY);
                break;
            ...
            case '1':
                this.tileStartPosX = x;
                this.tileStartPosY = y;
    ...
    Level.prototype.LoadNamedTile = function (name, collision, x, y) {
        switch (name) {
            case "Platform":
                return new Tile(this.levelContentManager.imgPlatform, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "Exit":
                return new Tile(this.levelContentManager.imgExit, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA0":
                return new Tile(this.levelContentManager.imgBlockA0, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA1":
                return new Tile(this.levelContentManager.imgBlockA1, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA2":
                return new Tile(this.levelContentManager.imgBlockA2, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA3":
                return new Tile(this.levelContentManager.imgBlockA3, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA4":
                return new Tile(this.levelContentManager.imgBlockA4, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA5":
                return new Tile(this.levelContentManager.imgBlockA5, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockA6":
                return new Tile(this.levelContentManager.imgBlockA6, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockB0":
                return new Tile(this.levelContentManager.imgBlockB0, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;

            case "BlockB1":
                return new Tile(this.levelContentManager.imgBlockB1, collision, x, y, this.scaleToFitX, this.scaleToFitY);
                break;
        }
    };
    ...
    Level.prototype.LoadStartTile = function (x, y) {
        ...
        this.Hero = new Player(this.levelContentManager.imgPlayer, this, this.Start, this.scaleToFitX, this.scaleToFitY);
    ...
    Level.prototype.LoadGemTile = function (x, y) {
        ...
        this.Gems.push(new Gem(this.levelContentManager.imgGem, this, position, this.scaleToFitX, this.scaleToFitY));
    ...
    Level.prototype.LoadEnemyTile = function (x, y, name) {
        ...
        switch (name) {
            case "MonsterA":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterA, this.scaleToFitX, this.scaleToFitY));
                break;
            case "MonsterB":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterB, this.scaleToFitX, this.scaleToFitY));
                break;
            case "MonsterC":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterC, this.scaleToFitX, this.scaleToFitY));
                break;
            case "MonsterD":
                this.Enemies.push(new Enemy(this, position, this.levelContentManager.imgMonsterD, this.scaleToFitX, this.scaleToFitY));
                break;
        }
    ...
    Level.prototype.GetBounds = function (x, y) {
        return new XNARectangle(x * StaticTile.Width * this.scaleToFitX, y * StaticTile.Height * this.scaleToFitY, StaticTile.Width * this.scaleToFitX, StaticTile.Height * this.scaleToFitY);
    };
    ...
    Level.prototype.Update = function () {
        ...
        if (!this.Hero.IsAlive || this.TimeRemaining === 0) {
            ...
            if (this.Hero.BoundingRectangle().Top() >= this.Height() * StaticTile.Height * this.scaleToFitY) {
                this.OnPlayerKilled();
            }
