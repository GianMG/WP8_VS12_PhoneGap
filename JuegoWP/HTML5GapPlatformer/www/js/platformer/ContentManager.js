...
function ContentManager(stage, width, height) {
    ...
    this.StartDownload = function () {
        ...
        if (audioExtension !== ".none") {
            SetAudioDownloadParameters(this.globalMusic, "assets/sounds/Music" + audioExtension);
            SetAudioDownloadParameters(this.playerKilled, "assets/sounds/PlayerKilled" + audioExtension);
            SetAudioDownloadParameters(this.playerJump, "assets/sounds/PlayerJump" + audioExtension);
            SetAudioDownloadParameters(this.playerFall, "assets/sounds/PlayerFall" + audioExtension);
            SetAudioDownloadParameters(this.exitReached, "assets/sounds/ExitReached" + audioExtension);
                ...
                for (var a = 0; a < 8; a++) {
                    ...
                    SetAudioDownloadParameters(this.gemCollected[a], "assets/sounds/GemCollected" + audioExtension);
                }
        }
        ...
        for (var i = 0; i < 3; i++) {
            ...
            for (var j = 0; j < 3; j++) {
                ...
                SetDownloadParameters(this.imgBackgroundLayers[i][j], "assets/images/backgrounds/Layer" + i + "_" + j + ".png");
            }
        }

        SetDownloadParameters(this.imgPlayer, "assets/images/sprites/Player.png");
        SetDownloadParameters(this.imgMonsterA, "assets/images/sprites/MonsterA.png");
        SetDownloadParameters(this.imgMonsterB, "assets/images/sprites/MonsterB.png");
        SetDownloadParameters(this.imgMonsterC, "assets/images/sprites/MonsterC.png");
        SetDownloadParameters(this.imgMonsterD, "assets/images/sprites/MonsterD.png");

        SetDownloadParameters(this.winOverlay, "assets/images/overlays/you_win.png");
        SetDownloadParameters(this.loseOverlay, "assets/images/overlays/you_lose.png");
        SetDownloadParameters(this.diedOverlay, "assets/images/overlays/you_died.png");

        SetDownloadParameters(this.imgBlockA0, "assets/images/tiles/BlockA0.png");
        SetDownloadParameters(this.imgBlockA1, "assets/images/tiles/BlockA1.png");
        SetDownloadParameters(this.imgBlockA2, "assets/images/tiles/BlockA2.png");
        SetDownloadParameters(this.imgBlockA3, "assets/images/tiles/BlockA3.png");
        SetDownloadParameters(this.imgBlockA4, "assets/images/tiles/BlockA4.png");
        SetDownloadParameters(this.imgBlockA5, "assets/images/tiles/BlockA5.png");
        SetDownloadParameters(this.imgBlockA6, "assets/images/tiles/BlockA6.png");
        SetDownloadParameters(this.imgBlockB0, "assets/images/tiles/BlockB0.png");
        SetDownloadParameters(this.imgBlockB1, "assets/images/tiles/BlockB1.png");
        SetDownloadParameters(this.imgGem, "assets/images/tiles/Gem.png");
        SetDownloadParameters(this.imgExit, "assets/images/tiles/Exit.png");
        SetDownloadParameters(this.imgPlatform, "assets/images/tiles/Platform.png");
    ...
    function handleElementError(e) {
        //document.getElementById("welcomeMsg").innerHTML = e.target.src;
        console.log("Error Loading Asset : " + e.target.src);
    }

    // Update methid which simply shows the current % of download
    this.tick = function() {
        downloadProgress.text = "Loading game " + Math.round((numElementsLoaded / NUM_ELEMENTS_TO_DOWNLOAD) * 100) + " %";
